...
public class XMLTranscoderTest {
	...
	public static void main(String[] args) {
		...
		String xml = new org.trpr.platform.integration.impl.xml.XMLTranscoderImpl().marshal(eventXML);
		...
		System.out.println(((org.trpr.platform.model.event.PlatformEventXML)
				new org.trpr.platform.integration.impl.xml.XMLTranscoderImpl().unmarshal(xml,org.trpr.platform.model.event.PlatformEventXML.class)).getPlatformEvent().getEventMessage());
	}
