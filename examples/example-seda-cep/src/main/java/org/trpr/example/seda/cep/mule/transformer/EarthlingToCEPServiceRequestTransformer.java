...
/**
 * The class <code>EarthlingToCEPServiceRequestTransformer</code> is a Mule message transformer implementation used in the sample
 ...
 */
public class EarthlingToCEPServiceRequestTransformer<T extends CEPServiceRequest> extends AbstractTransformer{
	
	/**
	 * Constants for service related attributes for this transformer
	 */
	private static final String SERVICE_NAME = "cepService";
	private static final String SERVICE_VERSION = "1.0";
	
	/**
	 * Constructor for this class
	 */
	public EarthlingToCEPServiceRequestTransformer() {
        super();
    ...
    /**
     * Overriden superclass method. Converts the Earthling object to a ServiceRequestImpl object that contains a CEPServiceRequest object
     * 
     * @see Earthling
    ...
    public Object doTransform(Object src, String encoding) throws TransformerException {
    	CEPServiceRequest cepServiceRequest = new CEPServiceRequest();
    	try {
    		...
    		ois.close();
    		cepServiceRequest.setEarthling(earthling);
    		cepServiceRequest.setVersion(SERVICE_VERSION);
    	} catch (Exception e) {
    		throw new TransformerException(this, e);
    	}
    	return new ServiceRequestImpl<CEPServiceRequest>(cepServiceRequest, SERVICE_NAME,cepServiceRequest.getVersion());
    }	
}
