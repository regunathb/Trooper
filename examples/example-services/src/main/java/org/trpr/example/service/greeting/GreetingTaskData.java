...
/**
 * The GreetingTaskData is data for the {@link GreetingTask}
 * 
 * @author Regunath B
...
public class GreetingTaskData<T extends Earthling, S extends Resource> extends TaskData {
	...
	public GreetingTaskData(T earthling) {
		super();
