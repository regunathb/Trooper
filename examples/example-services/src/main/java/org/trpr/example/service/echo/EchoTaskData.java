...
/**
 * The EchoTaskData is the task data that will be returned executing the EchoTask
 * 
 * @author Regunath B
 * @version 1.0, 23/08/2012
 */
@SuppressWarnings("rawtypes")
public class EchoTaskData<T extends Earthling, S extends Resource> extends TaskData {
	...
	public EchoTaskData(Earthling earthling) {
		super();
