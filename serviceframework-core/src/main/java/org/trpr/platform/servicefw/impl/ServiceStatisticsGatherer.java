 ...
 */
@ManagedResource(objectName = "spring.application:application=UID-Service-Statistics,type=ServiceStatisticsGatherer,name=ServiceStatisticsGatherer", description = "Service Invocation Statistics")
