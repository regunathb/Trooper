	...
	<div id="page">
		<div id="header">
			<div id="name-and-company">
				<div id='site-name'>
					<a href="/" title= "Site Name" rel="home"> Trooper Services Admin </a>
				</div>
			</div>
			<!-- /name-and-company -->
		</div>
		...
		<div id="primary-navigation">
			<div id="primary-left">
				<ul>
					<li><a href="/index.do">Services Home</a></li>
				</ul>
			</div>
			<div id="primary-right">
				<ul>
					<li><a href="https://github.com/regunathb/Trooper">Trooper GitHub</a></li>
				</ul>
			</div>
		</div>
		<!-- /primary-navigation -->
