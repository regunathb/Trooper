 ...
 * that specializes in serializing and de-serializing values of type {@link}java.lang.String. 
...
public class StringSerializer implements Serializer {
	...
	public byte[] toBytes(Object data) {
		if (data instanceof String) {
			...
			throw new IllegalArgumentException("java.lang.String expected");
		}
	}

	@Override
	public String toObject(byte[] dataBytes) {
