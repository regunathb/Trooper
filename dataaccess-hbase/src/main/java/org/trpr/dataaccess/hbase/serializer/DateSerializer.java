 ...
 * that specializes in serializing and de-serializing values of type {@link}
 * java.util.Date.
 * 
...
public class DateSerializer implements Serializer {
	...
	public byte[] toBytes(Object data) {
		if (data instanceof Date) {
			...
			throw new IllegalArgumentException("java.util.Date expected");
		}
	}

	@Override
	public Date toObject(byte[] dataBytes) {
		return new Date(Bytes.toLong(dataBytes));
	}
}
