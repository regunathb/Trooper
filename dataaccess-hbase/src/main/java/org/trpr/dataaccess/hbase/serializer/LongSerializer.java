 ...
 * that specializes in serializing and de-serializing values of type {@link}java.lang.Long. 
...
public class LongSerializer implements Serializer {
	...
	public byte[] toBytes(Object data) {
		if (data instanceof Long) {
			...
			throw new IllegalArgumentException("java.lang.Long expected");
		}
	}

	@Override
	public Long toObject(byte[] dataBytes) {
		return Long.valueOf(Bytes.toLong(dataBytes));
	}
}
